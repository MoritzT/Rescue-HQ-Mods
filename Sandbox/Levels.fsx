...
Def.Level.Add {
    ...
    Cells = [
        for x = 0 to 79 do yield Marker (x, -1, ZNeg) "Street"
        for x = 0 to 79 do yield Marker (x, 80, ZPos) "Street"
        for z = 0 to 79 do yield Marker (-1, z, XNeg) "Street"
        for z = 0 to 79 do yield Marker (80, z, XPos) "Street"
    ]
